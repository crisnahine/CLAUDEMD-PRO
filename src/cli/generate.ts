...
import ora from "ora";
import { analyzeCodebase, type CodebaseProfile } from "../analyzers/index.js";
...
function renderClaudeMd(profile: CodebaseProfile, opts: GenerateOptions): string {
 ...
 */
function getNotableDeps(stack: StackProfile): string[] {
